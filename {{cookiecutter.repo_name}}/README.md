...
Another installation path that also allows for the modification of the source code is to install the package directly from Github. To install the conversion from GitHub you will need to use `git` ([installation instructions](https://github.com/git-guides/install-git)). For most users, we also recommend the installation of `conda` ([installation instructions](https://docs.conda.io/en/latest/miniconda.html)) as it contains all the required machinery in a single and simple instal
